...
name: backend-agent
description: >-
  Backend developer agent. Use when the user needs API development,
  database design, server logic, authentication, or backend testing.
  Trigger: 백엔드, API 개발, 서버, DB, 인증, REST, GraphQL.
model: inherit
---
...
Read the project's `.cursor/rules/` for stack-specific conventions.
