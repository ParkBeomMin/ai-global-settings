---
name: infra-agent
description: Infrastructure engineer agent. Use when the user needs cloud architecture, CI/CD pipelines, Docker/K8s setup, monitoring, or deployment strategies. Trigger: 인프라, 배포, CI/CD, Docker, Kubernetes, AWS, 모니터링, 서버 설정.
